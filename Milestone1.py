...
Zoheb = Partner("Siddiqui", "Zoheb", "zzs5123")
Ed = Partner("Lai", "Edmud", "eddielai")
team = [Zoheb, Ed]
...
workload_distribution = '''Zoheb will have primary responsibility for the 
static evaluation function and implementing alpha-beta pruning, Edmund
will have primary responsibility for Zobrist hashing and implementing the minimax search,
and both partners expect to be closely involved in writing the move-generation
code and defining the personality of the agent.'''

reference1 = '''Wikipedia article on Baroque Chess;
    URL: https://en.wikipedia.org/wiki/Baroque_chess'''

reference2 = '''Strategies for chess programming,
    available online at: https://chessprogramming.wikispaces.com/Strategy'''

our_submission = Who_and_what([Zoheb, Ed], OPTION, title, approach, workload_distribution, [reference1, reference2])
